...
export const metadata: Metadata = {
  ...
  description:
    "The terms and conditions governing your access to and use of the Oakvale Learning educational platform.",
};
  ...
  return (
    <>
      <PageHero
        kicker="Legal"
        title="Terms and Conditions"
        description="The terms governing your access to and use of the Oakvale Learning educational platform."
      />
      ...
      <section className="py-16 sm:py-20">
        <Container size="narrow">
          <LegalBody>
            <p>
              Welcome to the Oakvale Learning Educational Platform! By accessing
              or using our services, you agree to comply with these terms and
              conditions. Please read them carefully. If you do not agree with any
              part of these terms, you must refrain from using our platform.
            </p>

            <h2>1. User Accounts</h2>
            <p>
              <strong>1.1 Account Creation:</strong> Users must provide accurate,
              complete, and up-to-date information when registering on the
              platform. Oakvale Learning reserves the right to suspend or terminate
            ...
            <p>
              ...
              all activities that occur under their account. Notify us immediately
              of any unauthorized use.
            </p>
            <p>
              <strong>1.3 Age Restrictions:</strong> Users must be at least 13
              years old to register. Those under 18 must have parental or guardian
            ...
            <p>
              ...
              the content for personal, non-commercial educational purposes.
            </p>
            <p>
              <strong>2.3 Restrictions:</strong> Users may not resell, reproduce,
              distribute, or modify platform content without prior written consent
              from Oakvale Learning.
            </p>
            ...
            <p>
              <strong>3.2 User-Generated Content:</strong> Users retain ownership
              of any content they upload (e.g., discussion forum posts), but grant
              Oakvale Learning a worldwide, royalty-free license to use, reproduce,
              and distribute this content for educational purposes.
            </p>
            <p>
            ...
            <p>
              <strong>4.2 Payment Terms:</strong> Users must use valid payment
              methods. By subscribing to a recurring plan, users authorize Oakvale
              Learning to charge the subscription fee automatically.
            </p>
            <p>
              <strong>4.3 Refund Policy:</strong> Refunds are available within 14
              days of purchase for courses that have not been accessed or
              completed. No refunds will be granted for completed courses.
            </p>

            <h2>5. Certificates and Credentials</h2>
            <p>
              <strong>5.1 Issuance:</strong> Certificates are awarded upon
              successful completion of courses that meet predefined requirements.
            </p>
            <p>
              <strong>5.2 Non-Academic Nature:</strong> Unless explicitly stated,
              certificates issued by Oakvale Learning do not equate to academic
              degrees or professional qualifications.
            </p>

            <h2>6. Privacy and Data Protection</h2>
            <p>
              <strong>6.1 User Data:</strong> Oakvale Learning collects and
              processes user data in compliance with its{" "}
              <Link href="/privacy">Privacy Policy</Link>.
            </p>
            <p>
              <strong>6.2 Third-Party Sharing:</strong> User data may be shared
              with third parties only with explicit consent or as required by law.
            </p>
            <p>
            ...
            <p>
              <strong>8.1 No Guarantee of Results:</strong> Oakvale Learning does
              not guarantee specific learning outcomes, certifications, or job
              placements.
            </p>
            <p>
              <strong>8.2 Service Availability:</strong> While we strive to
              maintain uninterrupted access, Oakvale Learning is not liable for
              downtime or technical issues.
            </p>
            <p>
              <strong>8.3 Liability Limits:</strong> Oakvale Learning&rsquo;s
              liability for damages is limited to the amount paid by the user for
              the services.
            </p>

            <h2>9. Modifications to Terms and Services</h2>
            <p>
              <strong>9.1</strong> Oakvale Learning reserves the right to modify
              these terms or services at any time. Users will be notified of
            ...
            <p>
              ...
              Users agree to resolve disputes in the jurisdiction of England and
              Wales.
            </p>
